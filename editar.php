    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" aria-current="" href="#info_gerais">Informações Gerais - </a>
            </li>
            <li class="nav-item" >
              <a class="nav-link" href="#info_pess">Informações Pessoais - </a>
            </li>
            <li class="nav-item" >
              <a class="nav-link" href="#End">Endereço - </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#Doc">Documentação</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <form method="POST" action="editar_action.php" class="row g-3 needs-validation" novalidate style="margin-left: 10px;margin-right: 10px;">
      ...
      <div class="col-md-4">
        <div class="input-group has-validation">
          ...
          <select name="Depart" class="form-select" id="validationCustom04" value="<?=$usuario['Depart']?>" required>
            ...
            <option <?=($usuario['Depart'] == 'Inventario')?'selected':''?> value="Inventario">Inventário</option>
        ...
        <div class="col-md-4">
          <div class="input-group has-validation">
            ...
            <select name="Carg" class="form-select" id="validationCustom04" required>
              ...
              <option <?=($usuario['Carg'] == 'Análista Sr')?'selected':''?> value="Análista Sr">Análista Sr</option>
              <option <?=($usuario['Carg'] == 'Análista Pl')?'selected':''?> value="Análista Pl">Análista Pl</option>
              <option <?=($usuario['Carg'] == 'Análista Jr')?'selected':''?> value="Análista Jr">Análista Jr</option>
      ...
      <div class="col-md-4">
        <div class="input-group has-validation">
          ...
          <select name="Tp_Adm" class="form-select" id="validationCustom04" required>
            <option  disabled value="">Escolha...</option>  
            <option <?=($usuario['Tp_Adm'] == 'Admissao')?'selected':''?> value="Admissao">1 - Admissão</option>
            <option <?=($usuario['Tp_Adm'] == 'Transferência de Empresa do mesmo grupo econômico')?'selected':''?> value="Transferência de Empresa do mesmo grupo econômico">2 - Transferência de empresa do mesmo grupo econômico</option>
            <option <?=($usuario['Tp_Adm'] == 'Admissão por sucessão, incorporação ou fusão')?'selected':''?> value="Admissão por sucessão, incorporação ou fusão">3 - Admissão por sucessão, incorporação ou fusão</option>
      ...
      <div class="col-md-4">
        <div class="input-group has-validation">
          ...
          <select name="Defi" class="form-select" id="validationCustom04" required>
            <option disabled value="">Escolha...</option>
            <option <?=($usuario['Defi'] == 'Nao')?'selected':''?> value="Nao">0 - Não</option>            
            <option <?=($usuario['Defi'] == 'Fisica')?'selected':''?> value="Fisica">1 - Física</option>            
        ...
        <div class="input-group has-validation">
          <span class="input-group-text" id="inputGroupPrepend">Estado Civil</span>
            <select name="Est_civi" class="form-select" id="validationCustom04" required>
              ...
              <option <?=($usuario['Est_civi'] == 'Viúvo')?'selected':''?> value="Viúvo">4 - Viúvo</option>
              <option <?=($usuario['Est_civi'] == 'União Estável')?'selected':''?> value="Solteiro">5 - União Estável</option>
      ...
      <div class="col-md-4">
        <div class="input-group has-validation">
          ...
          <option  disabled value="">Escolha...</option>
            <option <?=($usuario['Gr_instru'] == 'Até a 4º Série Incompleta')?'selected':''?> value="Até a 4º Série Incompleta">1 - Até a 4º Série Incompleta</option>
            <option <?=($usuario['Gr_instru'] == '4º Série Completa')?'selected':''?> value="4º Série Completa">2- 4º Série Completa</option>
            <option <?=($usuario['Gr_instru'] == 'Da 5º a 8º Série Incompleta')?'selected':''?> value="Da 5º a 8º Série Incompleta">3 - Da 5º a 8º Série Incompleta</option>
            <option <?=($usuario['Gr_instru'] == 'Fundamental Completo')?'selected':''?> value="Fundamental Completo">4 - Fundamental Completo</option>
            <option <?=($usuario['Gr_instru'] == '1º Grau Incompleto')?'selected':''?> value="1º Grau Incompleto">5 - 1º Grau Incompleto</option>
            <option <?=($usuario['Gr_instru'] == '1º Grau Completo')?'selected':''?> value="1º Grau Completo">6 - 1º Grau Completo</option>
            <option <?=($usuario['Gr_instru'] == '2º Grau Incompleto')?'selected':''?> value="2º Grau Incompleto">7 - 2º Grau Incompleto</option>
            <option <?=($usuario['Gr_instru'] == '2º Grau Completo')?'selected':''?> value="2º Grau Completo">8 - 2º Grau Completo</option>
            <option <?=($usuario['Gr_instru'] == '3º Grau Incompleto')?'selected':''?> value="3º Grau Incompleto">9 - 3º Grau Incompleto</option>
            <option <?=($usuario['Gr_instru'] == '3º Grau Completo')?'selected':''?> value="3º Grau Completo">10 - 3º Grau Completo</option>
            ...
            <option <?=($usuario['Gr_instru'] == 'Pós Graduação')?'selected':''?> value="Pós Graduação">13 - Pós Graduação</option>
      ...
      <div class="col-md-4">
        <div class="input-group has-validation">
          ...
          <select name="Inst_banc" class="form-select" id="validationCustom04" required>
            <option  disabled value="">Escolha...</option>
            <option <?=($usuario['Inst_banc'] == 'Itau Unibanco Banco Multiplo S.A')?'selected':''?> value="Itau Unibanco Banco Multiplo S.A.">Itaú Unibanco Banco Múltiplo S.A.</option>
      ...
      <div class="col-md-4">
        <div class="input-group has-validation">
          ...
          <select name="Tp_cont" class="form-select" id="validationCustom04" required>
            ...
            <option <?=($usuario['Tp_cont'] == 'Conta Poupanca')?'selected':''?> value="Conta Poupanca">Conta-Poupança</option>
          </select>
        </div>
      </div>
      <div class="col-12">
