...
if($id){
    $sql = $pdo->prepare("UPDATE cadastros SET Situ = :Situ, Tp_pgto = :Tp_pgto, Depart = :Depart, Carg = :Carg, Jor_sema = :Jor_sema, pp_adiant = :pp_adiant, Sal = :Sal, Dt_Adm = :Dt_Adm, Tp_Adm = :Tp_Adm, 
    Descri_fun = :Descri_fun, Nm_comple = :Nm_comple, Dt_nasc = :Dt_nasc, sex = :sex, Defi = :Defi, Est_civi = :Est_civi, Gr_instru = :Gr_instru, Nm_pai = :Nm_pai, Nm_mae = :Nm_mae, CEP = :CEP,
    tp = :tp, Rua = :Rua, Nm = :Nm, Comple = :Comple, Bairr = :Bairr, Cid = :Cid, Uf = :Uf, IBGE = :IBGE, Tel_Fix = :Tel_Fix, Cel = :Cel, Email = :Email, CPF = :CPF, RG = :RG, Org_Emiss = :Org_Emiss,
    PIS = :PIS, Tit_Ele = :Tit_Ele, Zona = :Zona, Sec = :Sec, Serv_milit = :Serv_milit, CNH = :CNH, Cat = :Cat, Dt_emiss = :Dt_emiss, Dt_ven = :Dt_ven, CTPS = :CTPS, Ser = :Ser, Dt_emiss_CNH = :Dt_emiss_CNH,
    RIC = :RIC, Inst_banc = :Inst_banc, Banc = :Banc, Ag = :Ag, Nm_cont = :Nm_cont, Tp_cont = :Tp_cont WHERE id = :id");
        $sql->bindValue(':id', $id);
